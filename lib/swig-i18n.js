...
exports.init_tag = function (translation_thing, next) {
  ...
  swig.setFilter('i18n', function(i18n_tag, language, default_translation, replacement_pairs) {

    var translation = translations && i18n_tag && language && translations[i18n_tag]
      && translations[i18n_tag][language] ? translations[i18n_tag][language]
      : default_translation;
